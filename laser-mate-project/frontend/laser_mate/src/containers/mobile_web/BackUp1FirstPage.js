...
function CustomerMeals(props) {
  ...
  useEffect(() => {
    axios.get(`http://localhost:8000/api/restaurant/${restaurant_id_path}`)
      .then(res => {
        console.log("useEffect1---------- " + res.data);
  ...
  useEffect(() => {
    axios.post(`http://localhost:8000/api/restaurant_serving_times/search`, { restaurant_id })
      .then(res => {
        console.log("useEffect2---------- " + res.data);
  ...
  const compute_current_restaurant_serving_time_id = () => { 
    let result = [];
    var today = new Date();
  ...
  useEffect(() => {
    ...
    axios.post(`http://localhost:8000/api/restaurant_serving_time_category_dishes/search`,  1  )
      .then(res => {
        console.log("useEffect4---------- " + res.data);
  ...
  // const computeRestaurantServingTimeCategories_id = () => {
  //   const default_id = 0;
  //   console.log("happy");
  //   console.log(restaurantServingTimeCategories[0].restaurant_serving_time_category_id);
  //   //let restaurantServingTimeCategories_id = restaurantServingTimeCategories[0].restaurant_serving_time_category_id;
